...
export default class UI {
    constructor(callback) {
        ...
        const events = [{
            ...
            {
                selector: '.menu-list',
                cb: this.onMenuPagingClick.bind(this)
            },
            {
                selector: '#button_video',
                cb: this.showPopup.bind(this, 'video', this.initVideo, this.destoryVideo)
            },
            {
            ...
            },
            {
                ...
                cb: this.showPopup.bind(this, 'team', this.initSlider, this.destroySlider)
            }
        ]
